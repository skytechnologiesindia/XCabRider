...
// Male Symbol Vector Icon (♂)
const MaleIcon = ({ size = 20, color = COLORS.textDark }) => (
  <View style={{ width: size, height: size, alignItems: 'center', justifyContent: 'center' }}>
    {/* Circle bottom-left */}
    <View
      style={{
    ...
    />
    {/* Arrow shaft pointing top-right */}
    <View
      style={{
        position: 'absolute',
        top: size * 0.22,
...
// Female Symbol Vector Icon (♀)
const FemaleIcon = ({ size = 20, color = COLORS.textDark }) => (
  <View style={{ width: size, height: size, alignItems: 'center', justifyContent: 'center' }}>
    {/* Circle top */}
    <View
      style={{
...
// Other / Inclusive Symbol Vector Icon (⚥)
const OtherIcon = ({ size = 20, color = COLORS.textDark }) => (
  <View style={{ width: size, height: size, alignItems: 'center', justifyContent: 'center' }}>
    {/* Central circle */}
    <View
      style={{
